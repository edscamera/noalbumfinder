...
export type LastFMArtistRemoveLastFMTagParams =
  LastFMRequestParams<LastFMParam> &
    Readonly<{
      tag: string;
      artist: string;
...
export type LastFMAuthGetMobileSessionParams =
  LastFMRequestParams<LastFMParam> &
    Readonly<{
      username: string;
      password: string;
...
export type LastFMTrackGetTopTagsParams = LastFMTrackParams &
  LastFMTrackOptionalParams;
...
export type LastFMUserGetLovedTracksParams = LastFMUserParams &
  LastFMUserOptionalParams;
